...
for publisher in publishers:
    ...
    for e in range(number_of_experiments):
        ...
        cts_learner2 = CTSLearner2(n_ads=N_ADS, n_slots=publisher.n_slots, n_class=N_CLASS)
        for t in range(T):
            # print(t)
            users = []
        ...
        cts_rewards_per_experiment_2.append(cts_learner2.collected_rewards)
